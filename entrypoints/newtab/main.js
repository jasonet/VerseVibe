...
import { BgLikeManager } from "./modules/bgLikes.js";
...
import { initializeDefaultTasks } from "./core/utils.js";
import { isYddStorageKey } from "./core/storageKeys.js";
import { SyncClient } from "./modules/sync.js";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  initialize("BG Likes", () => new BgLikeManager());
...
window.__yddSyncClient = syncClient;

if (syncClient.isEnabled()) {
  void syncClient.pullAndApply();
  state.subscribe(() => {
    syncClient.scheduleDebouncedPush();
  });
}
