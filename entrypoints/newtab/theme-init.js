...
try {
  ...
  // Background state (默认初始配置为随机图片背景 random，每次打开变化 refresh)
  var rawBgMode = localStorage.getItem("randomBgMode");
  var bgMode = rawBgMode === null ? '"random"' : rawBgMode;
  ...
  var parsedRandomBgSchedule = readStoredString(randomBgSchedule, "refresh");
  ...
  var request = indexedDB.open("VerseVibe_Dashboard_Storage", 2);
