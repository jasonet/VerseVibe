...
export class Search {
  ...
  buildHistoryModal() {
    ...
    infoBtn.addEventListener("click", () => {
      import("../core/utils.js").then(({ showCustomModal: scm }) => {
        scm(
  ...
  async startVoiceSearch() {
    ...
    this.els.voiceBtn.title = isZh ? "取消语音搜索" : "Cancel Voice Search";
    this.els.input.placeholder = isZh ? "正在请求麦克风..." : "Requesting microphone...";
    ...
    try {
      ...
      recognition.onstart = () => {
        ...
        this.els.voiceBtn.setAttribute("aria-label", isZh ? "停止语音搜索" : "Stop voice search");
        this.els.voiceBtn.title = isZh ? "停止语音搜索" : "Stop Voice Search";
        this.els.input.placeholder = isZh ? "请说话，正在倾听..." : "Listening...";
      };
