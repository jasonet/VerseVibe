...
VerseVibe 是一款革新性的浏览器翻译插件，专注于为用户提供无缝的双语阅读体验。它不仅仅是一个简单的翻译工具，更是一个智能的阅读助手，能够理解上下文语境，提供准确、自然的翻译结果。
...
观看[B站功能介绍视频](https://www.bilibili.com/video/BV1ux4y1e73x/)，快速了解 VerseVibe 的主要特性。
...
以下是 VerseVibe 与其他常见翻译工具的对比：

| 特性 | VerseVibe | *浏览器自带翻译* | *沉浸式翻译* |
|------|---------|--------------|------------|
...
准备好开始使用了吗？请查看[安装指南](./getting-started.md)章节，了解如何在几分钟内配置并开始使用 VerseVibe。
