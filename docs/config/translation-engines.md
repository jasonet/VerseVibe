...
灵魂树支持多种翻译引擎，包括传统机器翻译和大语言模型。本文将介绍各个翻译引擎的配置方法。
...
<img src="/click-fluent_read.png" alt="点击灵魂树图标" style="width: 80%; max-width: 100%;border: 1px solid #eee;border-radius: 4px;box-shadow: 0 1px 2px rgba(0,0,0,0.05);" />
...
#### 提示词配置
大语言模型的翻译效果很大程度上取决于提示词（Prompt）的设置。灵魂树提供了默认的提示词配置：
